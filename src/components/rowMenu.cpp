...
RowMenu::RowMenu(string title, vector<MenuOption *> options, Color &color, Color &titleColor, Color &selectedColor)
    : Menu(title, options, 0, 0, color, titleColor, selectedColor) {
  this->optionsContainer = new Row({}, 10);
